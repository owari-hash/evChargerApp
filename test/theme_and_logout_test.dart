...
Future<void> _login(WidgetTester tester) async {
  ...
  await tester.pump();
  final Finder loginBtn = find.text(AppStrings.get('login')).last;
  // On a small phone the sheet scrolls; bring the button into view first.
...
void main() {
  ...
  testWidgets('confirming logout returns to the login screen',
    ...
    await tester.tap(find.widgetWithText(FilledButton, AppStrings.get('logout')));
    await _pumpFrames(tester);
